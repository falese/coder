...
describe("react-ts eval suite", () => {
  ...
  test("generated output contains TypeScript constructs", () => {
    // At minimum, one of: interface, type, function, const, export, React.FC
    const hasTs =
  ...
  test("generated output has matching braces", () => {
    ...
    // Balanced braces → depth should return to 0
    expect(depth).toBe(0);
  });
});
